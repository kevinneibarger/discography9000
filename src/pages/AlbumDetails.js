...
//             const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=2949f3211285501034fe630a1cb58e85`);
...
//                         <span
//                             className="text-gray-900 dark:text-white">{movie.vote_count}&nbsp;reviews</span>
//                     </div>
